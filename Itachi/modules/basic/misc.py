...
from Itachi import START_TIME
from Itachi import SUDO_USER
from Itachi.helper.PyroHelpers import ReplyCheck
from Itachi.modules.help import add_command_help
from Itachi.modules.bot.inline import get_readable_time
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"└• **яєρσ**: [Click](https://GitHub.com/tushar007ff/chatbot1_0)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/tushar007ff/chatbot1_0 Fork & Give an ⭐")
